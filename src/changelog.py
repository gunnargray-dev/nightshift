...
Awake commit format:
    [awake] <type>: <description>

    <body>

    Session: <N>

The generator parses all commits matching `[awake]`, groups them by
...
@dataclass
class CommitRecord:
    """A single parsed Awake commit."""

    sha: str
    subject: str          # Full subject line, e.g. "[awake] feat: add stats"
...
class Changelog:
    ...
    def to_markdown(self) -> str:
        ...
        lines = [
            ...
            "",
            "*Auto-generated by Awake from git commit history.*",
            "",
        ]

        if not self.sections:
            lines.append("*No Awake commits found.*")
...
# Matches: [awake] feat: some description

    ...
    def do_GET(self) -> None:
        ...
        if self.path == "/api/sessions":
            try:
                ...
                repo = getattr(self.server, "repo_path", Path("."))
                stats = compute_stats(
                    repo_path=repo, log_path=repo / "AWAKE_LOG.md"
                )
...
Run: `cd /Users/gunnar/Documents/Dev/awake && python -m pytest tests/test_cli.py::TestBuildParser::test_dashboard_subcommand_parses -v`
...
Run: `cd /Users/gunnar/Documents/Dev/awake && python -m pytest tests/test_cli.py -v`
Expected: PASS
...
git commit -m "feat: add 'awake dashboard' CLI subcommand"
```
...
```bash
cd /Users/gunnar/Documents/Dev/awake/dashboard
npm install
...
Run: `cd /Users/gunnar/Documents/Dev/awake && python -m pytest tests/ -v`
...
```bash
cd /Users/gunnar/Documents/Dev/awake/dashboard && npm run dev
```
